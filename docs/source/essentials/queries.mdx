...
The following examples assume that you've already set up Apollo Android for your Android/Java application. Read our [getting started](../#getting-started) guide if you need help with either of those steps.
