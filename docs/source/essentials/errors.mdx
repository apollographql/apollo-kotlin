...
| `null`     | `null`     | `not null` | A GraphQL request error happened or a Graph field error bubbled up.         |
| `null`     | `not null` | `null`     | Complete data was received.                                                 |
| `null`     | `not null` | `not null` | Partial data was received alongside field error(s).                         |
| `not null` | `null`     | `null`     | A fetch error happened.                                                     |
| `not null` | `null`     | `not null` | 🙅‍♂️ impossible.                                                           |
| `not null` | `not null` | `null`     | 🙅‍♂️ impossible.                                                           |
| `not null` | `not null` | `not null` | 🙅‍♂️ impossible.                                                           |
