...
| `null`    | `null`  | `!null` | A GraphQL request error happened or a Graph field error bubbled up.         |
| `null`    | `!null` | `null`  | Complete data was received.                                                 |
| `null`    | `!null` | `!null` | Partial data was received alongside field error(s).                         |
| `!null`   | `null`  | `null`  | A fetch error happened.                                                     |
| `!null`   | `null`  | `!null` | 🙅‍♂️ impossible.                                                           |
| `!null`   | `!null` | `null`  | 🙅‍♂️ impossible.                                                           |
| `!null`   | `!null` | `!null` | 🙅‍♂️ impossible.                                                           |
