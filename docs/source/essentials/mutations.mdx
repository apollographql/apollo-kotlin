...
The GraphQL type system includes [input types](http://graphql.org/learn/schema/#input-types) as a way to pass complex values to fields. Input types are often used for mutation variables, because they provide a compact way to pass in objects to be created:
