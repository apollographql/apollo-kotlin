...
In many cases, you'll want to use mutation results to update your UI. [Fragments](./named-fragments) are a great way to share result handling between queries and mutations:
