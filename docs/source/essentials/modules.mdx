...
### apollo-annotations ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-annotations/index.html))
...
### apollo-api ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-api/index.html))
...
### apollo-ast ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-ast/index.html))
...
### apollo-compiler ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-compiler/index.html))
...
### apollo-debug-server ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-debug-server/index.html))

`apollo-debug-server` is a server that serves your normalized cache to the IntelliJ/Android Studio plugin.

### apollo-gradle-plugin ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-gradle-plugin/index.html))
...
### apollo-gradle-plugin-external ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-gradle-plugin-external/index.html))
...
### apollo-http-cache ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-http-cache/index.html))
...
### apollo-normalized-cache ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-normalized-cache/index.html))
...
### apollo-normalized-cache-api ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-normalized-cache-api/index.html))
...
### apollo-normalized-cache-sqlite ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-normalized-cache-sqlite/index.html))
...
### apollo-runtime ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime/index.html))
...
### apollo-testing-support ([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-testing-support/index.html))
...
### apollo-adapters (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime/index.html))
...
### apollo-api-java (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime/index.html))

`apollo-api-java` contains the symbols needed to compile the Java models.

This module is deprecated and moved to the Apollo Galaxy. See the [Apollo Galaxy page](https://www.apollographql.com/docs/kotlin/advanced/galaxy) for more details.

### apollo-engine-ktor (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-engine-ktor/index.html))

`apollo-engine-ktor` is an implementation of `HttpEngine` and `WebSocketEngine` that uses Ktor.

This module is deprecated and moved to the Apollo Galaxy. See the [Apollo Galaxy page](https://www.apollographql.com/docs/kotlin/advanced/galaxy) for more details.

### apollo-idling-resource (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-idling-resource/index.html))
...
### apollo-mockserver (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime/index.html))
...
### apollo-runtime-java (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime-java/index.html))
...
### apollo-rx2-support (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-rx2-support/index.html))
...
### apollo-rx3-support (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-rx3-support/index.html))
...
### apollo-rx2-support-java (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-rx2-support-java/index.html))

`apollo-rx2-support-java` provides adapter from `ApolloCall` to their RxJava3 equivalent.

This module is deprecated and moved to the Apollo Galaxy. See the [Apollo Galaxy page](https://www.apollographql.com/docs/kotlin/advanced/galaxy) for more details.

### apollo-rx3-support-java (DEPRECATED)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-rx3-support-java/index.html))
...
### apollo-mockserver (INTERNAL)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-runtime/index.html))
...
### apollo-tooling (INTERNAL)([kdoc](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-tooling/index.html))
