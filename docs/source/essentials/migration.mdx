...
Decide what to do with the codegen

### Variables are non-optional by default

### Enums

Enums are generated as sealed classes by default.
Enums keep the case of their GraphQL definition (instead of always being transformed to uppercase in 2.x). See https://github.com/apollographql/apollo-android/issues/3035
...
```groovy:title=build.gradle
  ...
  // With:
  androidTestImplementation("com.apollographql.apollo3:apollo-idling-resource:x.y.z") // highlight-line
```
