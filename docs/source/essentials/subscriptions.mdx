...
## Experimental WebSocket APIs

Starting with 4.0.0, Apollo Kotlin provides new experimental WebSocket APIs that aim to replace the current implementation in the future.
