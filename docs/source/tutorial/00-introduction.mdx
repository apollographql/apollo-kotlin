...
To focus on the important parts, this tutorial uses a starter project available at [https://github.com/apollographql/apollo-android-tutorial](https://github.com/apollographql/apollo-android-tutorial) so you don't have to deal with project setup and boilerplate.
