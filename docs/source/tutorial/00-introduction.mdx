...
The tutorial uses an instance of [Apollo Server](https://www.apollographql.com/docs/apollo-server/) hosted on Heroku, including
the [corresponding GraphQL Playground](https://apollo-fullstack-tutorial.herokuapp.com/). If you're curious about how to build your own
...
To focus its scope, this tutorial uses a starter project available at https://github.com/apollographql/apollo-android-3-tutorial so you can
focus on the GraphQL parts.

> If you encounter any issues during the tutorial, feel free to ask questions by either [opening an issue on our GitHub repo](https://github.com/apollographql/apollo-android/issues), [joining the community](http://community.apollographql.com/new-topic?category=Help&tags=mobile,client) or [stopping by the Slack channel]( https://app.slack.com/client/T09229ZC6/C01A6KM1SBZ).
