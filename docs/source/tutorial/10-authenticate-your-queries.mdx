...
**Note**: Here the singleton handled manually for sample purposes. In a real life application, you would certainly use a dependency injection framework such as `Dagger` or `Koin`.
