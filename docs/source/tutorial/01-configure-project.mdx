...
The starter project is in the `initial` folder. 

At any time, if you want to view a completed version of the project, open the project in the `finished` folder.
...
This tutorial uses `3.7.3` because it is the latest version at the time of writing. Feel free to use a more recent version if one is available.
