...
You should still have the yellow banner, `A project sync may be necessary for the IDE to work properly.` from the [previous step](01-configure-project). Now is time to Click **Sync Now**.

If everything goes well, Apollo Kotlin is now added to your project. Next, [write your first query](03-write-your-first-query) that uses this schema.
