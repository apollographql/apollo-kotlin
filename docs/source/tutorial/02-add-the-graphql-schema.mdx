...
Apollo Android requires a schema to generate typesafe models and code from your queries. There are multiple ways to get a schema. For an exemple, you can download a json schema directly from GraphQL Playground by clicking **Schema > Download** in the right pane.
