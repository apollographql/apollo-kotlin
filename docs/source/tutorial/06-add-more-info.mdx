---
title: "6. Add more infos to the list"
---
...
Any GraphQL field can take arguments like `missionPatch` above and arguments can be of scalar or complex types. In this case, `SMALL` is an enum in the GraphQL schema. It can take a finite list of values. If you look at the GraphiQL docs pane, you will see that size is an argument of type `PatchSize` that can only take two values: `SMALL` and `LARGE`
