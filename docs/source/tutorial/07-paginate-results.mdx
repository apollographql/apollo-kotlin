...
> **Note:** this is a basic implementation of paging in Compose. In a real project you would use something more advanced, like the [Jetpack Paging library](https://developer.android.com/jetpack/compose/lists#large-datasets).
