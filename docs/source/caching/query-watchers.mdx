...
First, configure the cache to support optimistic updates (they are disabled by default to avoid the overhead of keeping track of the optimistic data if you don't use it):
