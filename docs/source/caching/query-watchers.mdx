---
title: Watch your queries
---

Because the normalized cache deduplicates all your data, you can use it a the source of truth for your UI and be automatically notified when some data changes. For this you can use `ApolloQueryCall.watch`
