...
Since the garbage collection process can be potentially be resource-intensive and time-consuming, we recommend running it in a background task during periods of low activity in your application,
