...
```kotlin
plugins {
  id("com.apollographql.apollo") version "5.0.0-rc.0"
}
```
...
```kotlin
dependencies {
  implementation("com.apollographql.apollo:apollo-runtime:5.0.0-rc.0")
}
```
...
The latest version is `5.0.0-rc.0`.
...
dependencies {
  ...
  implementation("com.apollographql.apollo:apollo-normalized-cache-sqlite:5.0.0-rc.0")
  // Optional: if you just want the generated models and parsers and write your own HTTP code/cache code, you can remove apollo-runtime
  // and use apollo-api instead
  implementation("com.apollographql.apollo:apollo-api:5.0.0-rc.0")
}
```
