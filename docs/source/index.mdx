...
> 📣 **Migration guide:** if you're using Apollo Kotlin 4, see the [migration guide](/kotlin/migration/5.0/). You can also [view the 4.x docs](https://www.apollographql.com/docs/kotlin/v4).
...
| Apollo        | Gradle       | KGP (Android/JVM) | KGP (JS/Native) | AGP            |
|---------------|--------------|-------------------|-----------------|----------------|
| 5.0.0+        | 8.0+         | 2.1.0+            | 2.2.0+          | 8.0.0+         |
| 4.4.3         | 8.0+         | 1.9.0+            | 2.2.0+          | 8.0.0+         |
| 4.4.2         | 8.0+         | 1.9.0 - 2.3.21    | 2.2.0 - 2.3.21  | 8.0.0+         |
| 4.1.1 - 4.4.1 | 8.0+         | 1.9.0 - 2.3.21    | 2.1.0 - 2.3.21  | 8.0.0 - 8.13.2 |
| 4.0.0 - 4.1.0 | 8.0 - 8.14.4 | 1.9.0 - 2.3.21    | 2.1.0 - 2.3.21  | 8.0.0 - 8.13.2 |
...
dependencies {
  ...
  implementation("com.apollographql.apollo:apollo-normalized-cache-sqlite:5.1.0")
  // Optional: if you just want the generated models and parsers and write your own HTTP code/cache code, you can remove apollo-runtime
  // and use apollo-api instead
  implementation("com.apollographql.apollo:apollo-api:5.1.0")
}
```
...
Previews are published every night 3am UTC time. You can get them by replacing `-SNAPSHOT` with the desired date (e.g. `4.0.2-20241005`). They have 1 year retention.
