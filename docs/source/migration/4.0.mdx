...
While most of the core APIs stayed the same, Apollo Kotlin 4 contains a few binary breaking changes. To account for that, and in order to be more future-proof, [we changed the package name](https://github.com/apollographql/apollo-kotlin/issues/4710) to `com.apollographql.apollo`.
...
* [the multi-module apolloMetadata Gradle configuration is not used anymore](#multi-module-dependson)
