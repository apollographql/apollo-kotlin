...
* Configuring your cache after enabling APQs will now fail (see https://github.com/apollographql/apollo-kotlin/pull/4709)
* The AST classes (GQLNode and subclasses) are not data classes anymore (see https://github.com/apollographql/apollo-kotlin/pull/4704/)
...
To ease the migration to v4, the v3 behavior can be restored by by calling `ApolloClient.Builder.useV3ExceptionHandling(true)`.
