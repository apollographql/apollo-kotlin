...
Apollo Kotlin 4 uses a new identifier for its package name, Gradle plugin id, and maven group id: **`com.apollographql.apollo`**.
...
Apollo Kotlin 4 classes are imported from the `com.apollographql.apollo` package:
