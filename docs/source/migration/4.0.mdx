...
* Because Apollo Kotlin now supports different operation manifest formats, `operationOutput.json` has moved from `"build/generated/oeprationOutput/apollo/$service/operationOutput.json"` to `"build/generated/manifest/apollo/$service/operationOutput.json"` 
