...
The deprecated Gradle Plugin is now removed. Please refer to [the migration guide](/essentials/migration/#gradle-plugin-changes) from previous releases before upgrading to 2.0.
