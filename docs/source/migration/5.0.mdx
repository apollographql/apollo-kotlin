...
`apollo-http-cache` is now deprecated. Instead, Apollo Kotlin can use the existing OkHttp cache using [cacheUrlOverride](https://square.github.io/okhttp/5.x/okhttp/okhttp3/-request/-builder/cache-url-override.html).
