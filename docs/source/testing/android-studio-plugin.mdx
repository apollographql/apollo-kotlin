...
To help your day-to-day development with Apollo Kotlin, [a plugin](https://plugins.jetbrains.com/plugin/20645-apollo-graphql) for Android Studio and IntelliJ is available.
...
Please check the [plugin page](https://github.com/apollographql/apollo-intellij-plugin#compatibility) for the compatible IDE versions.
