...
Apollo Android requires your GraphQL server's schema as a `schema.graphqls` file. You can obtain the contents of this file by running an introspection query on your server.
