...
```kotlin
dependencies {
  implementation("com.apollographql.apollo3:apollo-runtime:4.0.0-dev.1")
}
```
...
dependencies {
  ...
  implementation("com.apollographql.apollo3:apollo-normalized-cache-sqlite:4.0.0-dev.1")
  // optional: if you just want the generated models and parsers and write your own HTTP code/cache code, you can remove apollo-runtime
  // and use apollo-api instead
  implementation("com.apollographql.apollo3:apollo-api:4.0.0-dev.1")
}
```
...
```
And then use the `4.0.0-dev.2-SNAPSHOT` version for the plugin and libraries.
