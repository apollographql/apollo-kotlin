---
title: Using a custom HTTP library
sidebar_title: Custom HTTP libraries
---

By default, Apollo Android uses the following HTTP libraries for different platforms/languages:
...
You can use a different HTTP library with Apollo Android by creating a custom class that implements the `HttpEngine` interface.
...
After you create your `HttpEngine` implementation, you can register it with your [`ApolloClient`](https://apollographql.github.io/apollo-android/kdoc/apollo-runtime/com.apollographql.apollo3/-apollo-client/index.html) instance using [`HttpNetworkTransport`](https://apollographql.github.io/apollo-android/kdoc/apollo-runtime/com.apollographql.apollo3.network.http/-http-network-transport/index.html):
...
* [No runtime](no-runtime): You can opt out of the Apollo Android runtime completely and only use generated models and parsers. Use this option if you don't need any of the runtime features (caching, batching, automatic persisted queries, etc.).
