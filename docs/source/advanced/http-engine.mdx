...
By default, Apollo Android uses [OkHttp](https://square.github.io/okhttp/) on Android, [Ktor](https://ktor.io/) on JavaScript and [NSURLSesssion](https://developer.apple.com/documentation/foundation/nsurlsession) on iOS/MacOS to execute your HTTP queries.
