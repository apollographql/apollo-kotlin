...
The models produced by the **Response based** codegen are generally nicer to use and more performant, at the cost of a greater size of the generated code.
...
To use the Response based codegen:
