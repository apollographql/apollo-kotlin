...
They serve as or playground for new ideas (`apollo-kotlin-compose-support`, `apollo-kotlin-normalized-cache-incubating`) or helper projects providing additional functionality that is not core to Apollo Kotlin (`apollo-kotlin-mockserver`, `apollo-kotlin-cli`, `apollo-kotlin-execution`)
