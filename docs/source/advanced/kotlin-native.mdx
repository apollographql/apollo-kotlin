...
Apollo Kotlin supports multiple native targets, including iOS, MacOS.

Apollo Kotlin requires the [new Kotlin Native Memory Manager](https://blog.jetbrains.com/kotlin/2021/08/try-the-new-kotlin-native-memory-manager-development-preview/). It is enabled by default since Kotlin 1.7.20. If you're using a version of Kotlin lower than 1.7.20, you need to opt-in:
