...
<Note>
The `bidirectional` parameter is experimental because it may break [Gradle project isolation](https://docs.gradle.org/current/userguide/build_environment.html). For a project-isolation compatible method, try [isADependencyOf](https://www.apollographql.com/docs/kotlin/kdoc/apollo-gradle-plugin-external/com.apollographql.apollo3.gradle.api/-service/is-a-dependency-of.html) 
</Note>
