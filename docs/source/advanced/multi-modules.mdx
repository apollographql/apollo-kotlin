...
For multi-modules projects, Apollo Android allows to define queries in a feature module and reuse fragments and types from another parent module. 
...
Please [report any issue](https://github.com/apollographql/apollo-android/issues/new?assignees=&labels=Type%3A+Bug&template=bug_report.md&title=[Multi-Modules]). For a more complete exemple, check the [multi-modules](https://github.com/apollographql/apollo-android-tutorial/tree/multi-modules) branch of the Apollo Android tutorial. 
