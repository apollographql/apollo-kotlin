...
For a more complete exemple, check the [multi-modules](https://github.com/apollographql/apollo-android-tutorial/tree/multi-modules) branch of the Apollo Android tutorial.
