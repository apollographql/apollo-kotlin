...
Apollo Android provides a built-in [`IdlingResource`](https://developer.android.com/reference/androidx/test/espresso/IdlingResource) to help you write UI tests with Espresso. The `ApolloIdlingResource` makes sure that your tests wait for your GraphQL queries to terminate before proceeding.
