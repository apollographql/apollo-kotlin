...
[![apollo-idling-resource](https://img.shields.io/maven-central/v/com.apollographql.apollo/apollo-idling-resource?label=apollo-idling-resource)](https://search.maven.org/artifact/com.apollographql.apollo/apollo-idling-resource)
```groovy
