...
For both operations and input objects, having to wrap values in an [`Optional`](https://apollographql.github.io/apollo-kotlin/kdoc/apollo-api/com.apollographql.apollo.api/-optional/index.html) wrapper can be cumbersome.0
...
If you do, in the case of the `GetTodos` query shown above, Apollo Kotlin now generates `Builders`:
