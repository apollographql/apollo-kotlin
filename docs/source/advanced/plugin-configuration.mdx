...
If you want several variants to share the same operations/schema, you can set the GraphQL source folder in the Service lambda, based on the variant name, for instance:
