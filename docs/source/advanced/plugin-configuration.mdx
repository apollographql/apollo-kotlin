...
Apollo Android's default configuration works for the majority of use cases. If you're getting started, see the [getting started guide](../introduction/) for an overview of the default configuration.
