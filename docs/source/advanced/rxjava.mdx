...
dependencies {
  ...
  // For RxJava 2
  implementation("com.apollographql.apollo3:apollo-rx2-support-java:4.0.0-beta.1")

  // For RxJava 3
  implementation("com.apollographql.apollo3:apollo-rx3-support-java:4.0.0-beta.1")
}
```
...
dependencies {
  ...
  // For RxJava 2
  implementation("com.apollographql.apollo3:apollo-rx2-support:4.0.0-beta.1")

  // For RxJava 3
  implementation("com.apollographql.apollo3:apollo-rx3-support:4.0.0-beta.1")
}
```
