...
import com.apollographql.apollo.ApolloPrefetchCallback;
...
public class ApolloPrefetchCallbackTest {
  ...
  @Test public void onHttpError() throws Exception {
    ...
    apolloClient.prefetch(emptyQuery).enqueue(ApolloPrefetchCallback.wrap(new ApolloPrefetch.Callback() {
