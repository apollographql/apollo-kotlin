 ...
 * normalized cache when a network request is made.
 */
public enum CacheControl {

  /**
   * Signals the apollo client to first fetch the GraphQL data from the normalized cache. If it's not present in the
  ...
  CACHE_FIRST,
  /**
   * Signals the apollo client to <b>only</b> fetch the GraphQL data from the normalized cache. If it's not present in
  ...
  CACHE_ONLY,
  /**
   * Signals the apollo client to first fetch the GraphQL data from the network. If network request fails, then the
