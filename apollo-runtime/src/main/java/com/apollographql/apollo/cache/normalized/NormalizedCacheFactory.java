 ...
 * in {@link com.apollographql.apollo.ApolloClient.Builder#withCustomTypeAdapter(ScalarType, CustomTypeAdapter)}.
 */
public interface NormalizedCacheFactory<T extends NormalizedCache> {
   ...
   *                           com.apollographql.apollo.ApolloClient.Builder#withCustomTypeAdapter(ScalarType,
   *                           CustomTypeAdapter)}.
