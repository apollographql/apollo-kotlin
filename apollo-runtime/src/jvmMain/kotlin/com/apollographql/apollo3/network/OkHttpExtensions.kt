 ...
 */
fun HttpNetworkTransport.Builder.okHttpClient(okHttpClient: OkHttpClient) {
  httpEngine(OkHttpEngine(okHttpClient))
}
 ...
 */
fun HttpNetworkTransport.Builder.okHttpCallFactory(okHttpCallFactory: Call.Factory) {
 ...
 */
fun WebSocketNetworkTransport.Builder.okHttpClient(okHttpClient: OkHttpClient) {
  webSocketEngine(OkHttpWebSocketEngine(okHttpClient))
}
