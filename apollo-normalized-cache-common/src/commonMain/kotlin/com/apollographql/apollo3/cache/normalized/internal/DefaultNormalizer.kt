...
/**
 * A [DefaultNormalizer] takes a [Map]<String, Any?> and turns them into a flat list of [Record]
...
class DefaultNormalizer(
  ...
  override fun normalize(map: Map<String, Any?>, selections: List<CompiledSelection>): Map<String, Record> {
