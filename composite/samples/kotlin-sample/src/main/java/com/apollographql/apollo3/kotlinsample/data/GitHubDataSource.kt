...
abstract class  GitHubDataSource(protected val apolloClient: ApolloClient) {
  ...
  protected val commitsSubject: PublishSubject<List<GithubRepositoryCommitsQuery.Data.Viewer.Repository.Ref.CommitTarget.History.Edge>> = PublishSubject.create()
  ...
  val commits: Observable<List<GithubRepositoryCommitsQuery.Data.Viewer.Repository.Ref.CommitTarget.History.Edge>> = commitsSubject.hide()
