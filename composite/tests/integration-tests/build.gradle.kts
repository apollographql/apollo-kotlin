...
fun addTests(models: String, addTask: Boolean) {
  val sourceSetName = "test${models.capitalizeFirstLetter()}"
  ...
  configureApollo(models, sourceSetName)
...
addTests("responseBased", true)

fun configureApollo(models: String, sourceSetName: String) {
