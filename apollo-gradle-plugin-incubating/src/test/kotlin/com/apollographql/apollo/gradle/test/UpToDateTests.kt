...
class UpToDateTests {
  ...
  fun `setting singularizeTypes in the build script re-generates the CustomType class`(dir: File) {
    val apolloBlock = """
      apollo {
    ...
    TestUtils.assertFileContains(dir, "main/service/com/example/type/CustomType.java", "Friends")
