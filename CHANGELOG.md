...
[gradle-plugin] Fix a regression in alwaysGenerateTypesMatching (#5605)
[️compiler] Add Apollo compiler plugin API (#5604, #5599, #5591, #5589, #5588, #5582, #5573, #5561, #5560, #5557, #5556, #5554, #5516)
...
[️compiler] Make `packageNameGenerator` work again + add test (#5589)
...
[tooling] bump bootstraped version of Apollo to `4.0.0-beta.3` (#5452)
