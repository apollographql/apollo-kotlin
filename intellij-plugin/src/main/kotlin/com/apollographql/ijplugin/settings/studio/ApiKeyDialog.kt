  ...
  override fun createCenterPanel(): DialogPanel = panel {
    row {
      ...
      cell(textFieldWithCompletion)
          ...
          .comment(ApolloBundle.message("settings.studio.apiKeyDialog.graphqlProjectName.comment"))
          .horizontalAlign(HorizontalAlign.FILL)
          .bind({ textField -> textField.text }, { textField, text -> textField.text = text }, ::graphqlProjectName.toMutableProperty())
