...
fun findAllModels(project: Project): List<KtClass> {
  val operationInheritors = findInheritorsOfClass(project, "com.apollographql.apollo.api.Operation").filterIsInstance<KtLightClassBase>()
  val fragmentDataInheritors = findInheritorsOfClass(project, "com.apollographql.apollo.api.Fragment.Data").filterIsInstance<KtLightClassBase>()
