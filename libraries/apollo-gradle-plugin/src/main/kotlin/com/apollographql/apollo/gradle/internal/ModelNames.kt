...
internal object ModelNames {
  ...
  fun generateApolloProjectIdeModel() = "generateApolloProjectIdeModel"
  fun generateApolloServiceIdeModel(service: Service) = camelCase("generate", service.name, "ApolloServiceIdeModel")
