...
/**
 * Base interface for [Operation] and [Fragment] that have an [DataAdapter] and [Variables].
 *
...
interface Executable<D: Executable.Data> {
  /**
   * The [DataAdapter] that maps the server response data to/from generated model class [D].
   *
