...
internal object ClassNames {
  ...
  val DataBuilder = ResolverClassName(apolloApiPackageName, "DataBuilder")
  ...
  val CustomScalarAdaptersEmpty = ResolverClassName(apolloApiPackageName, "CustomScalarAdapters", "Empty")
  ...
  val BaseFakeResolver = ResolverClassName(apolloApiPackageName, "BaseFakeResolver")
  val FakeResolver = ResolverClassName(apolloApiPackageName, "FakeResolver")
  val FakeResolverContext = ResolverClassName(apolloApiPackageName, "FakeResolverContext")
  ...
  val ExecutableDefinition = ResolverClassName(apolloApiPackageName, "ExecutableDefinition")
}
