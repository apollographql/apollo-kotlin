...
internal object KotlinSymbols {
  ...
  val BooleanExpression = ClassNames.BooleanExpression.toKotlinPoetClassName()
  val BTerm = ClassNames.BTerm.toKotlinPoetClassName()
  ...
  val ErrorAwareAnyAdapter = MemberName(apolloApiPackageName, "ErrorAwareAnyAdapter")
  val ErrorAwareBooleanAdapter = MemberName(apolloApiPackageName, "ErrorAwareBooleanAdapter")
  val ErrorAwareDoubleAdapter = MemberName(apolloApiPackageName, "ErrorAwareDoubleAdapter")
  val ErrorAwareIntAdapter = MemberName(apolloApiPackageName, "ErrorAwareIntAdapter")
  val ErrorAwareStringAdapter = MemberName(apolloApiPackageName, "ErrorAwareStringAdapter")
  val ErrorAwareLongAdapter = MemberName(apolloApiPackageName, "ErrorAwareLongAdapter")
  val ErrorAwareNullableAnyAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableAnyAdapter")
  val ErrorAwareNullableBooleanAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableBooleanAdapter")
  val ErrorAwareNullableDoubleAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableDoubleAdapter")
  val ErrorAwareNullableIntAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableIntAdapter")
  val ErrorAwareNullableStringAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableStringAdapter")
  val ErrorAwareNullableLongAdapter = MemberName(apolloApiPackageName, "ErrorAwareNullableLongAdapter")
  val CatchToNullAnyAdapter = MemberName(apolloApiPackageName, "CatchToNullAnyAdapter")
  val CatchToNullBooleanAdapter = MemberName(apolloApiPackageName, "CatchToNullBooleanAdapter")
  val CatchToNullDoubleAdapter = MemberName(apolloApiPackageName, "CatchToNullDoubleAdapter")
  val CatchToNullIntAdapter = MemberName(apolloApiPackageName, "CatchToNullIntAdapter")
  val CatchToNullStringAdapter = MemberName(apolloApiPackageName, "CatchToNullStringAdapter")
  val CatchToNullLongAdapter = MemberName(apolloApiPackageName, "CatchToNullLongAdapter")
