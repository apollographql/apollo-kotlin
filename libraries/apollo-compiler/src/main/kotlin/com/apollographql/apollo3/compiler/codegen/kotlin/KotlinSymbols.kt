...
internal object KotlinSymbols {
  ...
  val SerializeDataContext = ClassNames.SerializeDataContext.toKotlinPoetClassName()
  val DeserializeDataContext = ClassNames.DeserializeDataContext.toKotlinPoetClassName()
