...
internal object Identifier {
  ...
  const val serializeCompositeContext = "serializeCompositeContext"
  const val customScalarAdapters = "customScalarAdapters"
  const val value = "value"
  const val reader = "reader"
  const val writer = "writer"
  const val serializeComposite = "serializeComposite"
  const val build = "build"
  const val deserializeComposite = "deserializeComposite"
