...
internal object JavaClassNames {
  ...
  val DataSerializeContext = ClassNames.DataSerializeContext.toJavaPoetClassName()
  val DataDeserializeContext = ClassNames.DataDeserializeContext.toJavaPoetClassName()
