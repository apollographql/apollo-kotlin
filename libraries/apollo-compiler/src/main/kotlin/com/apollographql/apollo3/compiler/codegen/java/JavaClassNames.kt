...
internal object JavaClassNames {
  ...
  val SerializeCompositeContext = ClassNames.SerializeCompositeContext.toJavaPoetClassName()
  val DeserializeCompositeContext = ClassNames.DeserializeCompositeContext.toJavaPoetClassName()
