...
/**
 * Merger for the [com.apollographql.apollo.network.IncrementalDeliveryProtocol.V0_1] protocol format.
 */
@Suppress("UNCHECKED_CAST")
internal class V0_1IncrementalResultsMerger : IncrementalResultsMerger {
