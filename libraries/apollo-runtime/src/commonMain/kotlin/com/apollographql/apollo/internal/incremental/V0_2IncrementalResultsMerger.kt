...
/**
 * Merger for the [com.apollographql.apollo.network.IncrementalDeliveryProtocol.V0_2] protocol format.
 */
@Suppress("UNCHECKED_CAST")
internal class V0_2IncrementalResultsMerger : IncrementalResultsMerger {
