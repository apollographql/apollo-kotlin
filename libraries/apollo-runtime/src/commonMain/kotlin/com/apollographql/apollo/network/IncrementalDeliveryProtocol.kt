...
enum class IncrementalDeliveryProtocol {
  /**
   * Initial draft format as specified in this historical commit:
   * https://github.com/graphql/graphql-spec/tree/48cf7263a71a683fab03d45d309fd42d8d9a6659/spec,
   * and implemented by `graphql.js` version `17.0.0-alpha.2`
   *
  ...
  /**
   * Draft format as specified by https://specs.apollo.dev/incremental/v0.1/, and implemented by `graphql.js` version `17.0.0-alpha.9`.
   *
