...
//
package com.example.singularize_types;
...
import com.example.singularize_types.type.CustomType;
import com.example.singularize_types.type.Episode;
...
public final class TestQuery implements Query<TestQuery.Data, Optional<TestQuery.Data>, TestQuery.Variables> {
  ...
  public static class Hero {
    ...
    final Optional<List<Friends>> friends;
    ...
    public Hero(@NotNull String __typename, @Nullable List<Friends> friends) {
     ...
     */
    public Optional<List<Friends>> friends() {
      return this.friends;
    }
          ...
          writer.writeList($responseFields[1], friends.isPresent() ? friends.get() : null, new ResponseWriter.ListWriter() {
            ...
            public void write(List items, ResponseWriter.ListItemWriter listItemWriter) {
              for (Object item : items) {
                listItemWriter.writeObject(((Friends) item).marshaller());
              }
            }
          });
        }
    ...
    public static final class Mapper implements ResponseFieldMapper<Hero> {
      ...
      public Hero map(ResponseReader reader) {
        ...
        final List<Friends> friends = reader.readList($responseFields[1], new ResponseReader.ListReader<Friends>() {
          @Override
          public Friends read(ResponseReader.ListItemReader listItemReader) {
            return listItemReader.readObject(new ResponseReader.ObjectReader<Friends>() {
              @Override
              public Friends read(ResponseReader reader) {
                return friendsFieldMapper.map(reader);
              }
            });
          }
        });
  ...
  public static class Friends {
    ...
    public Friends(@NotNull String __typename, @NotNull String id) {
      this.__typename = Utils.checkNotNull(__typename, "__typename == null");
    ...
    public static final class Mapper implements ResponseFieldMapper<Friends> {
      @Override
      public Friends map(ResponseReader reader) {
        final String __typename = reader.readString($responseFields[0]);
        final String id = reader.readCustomType((ResponseField.CustomTypeField) $responseFields[1]);
        return new Friends(__typename, id);
      }
    }
  }
}
