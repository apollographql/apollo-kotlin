...
internal class TestQuery_ResponseAdapter(
  ...
  class Hero(
    ...
    val CharacterHeroAdapter: CharacterHero =
        com.example.simple_fragment.adapter.TestQuery_ResponseAdapter.Hero.CharacterHero(responseAdapterCache)

    val CharacterHumanHeroAdapter: CharacterHumanHero =
        com.example.simple_fragment.adapter.TestQuery_ResponseAdapter.Hero.CharacterHumanHero(responseAdapterCache)

    val OtherHeroAdapter: OtherHero =
        com.example.simple_fragment.adapter.TestQuery_ResponseAdapter.Hero.OtherHero(responseAdapterCache)
