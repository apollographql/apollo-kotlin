...
public final class FragmentFriendsConnection implements GraphQLQuery<FragmentFriendsConnection.Data> {
  private final String OPERATION_DEFINITION = "query FragmentFriendsConnection {\n"
      + "  hero {\n"
      + "    __typename\n"
      + "    ...HeroDetails\n"
      + "  }\n"
