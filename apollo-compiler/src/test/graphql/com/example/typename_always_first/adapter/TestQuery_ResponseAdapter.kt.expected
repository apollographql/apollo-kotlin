...
class TestQuery_ResponseAdapter(
  ...
  class Hero(
    ...
    val HumanHeroAdapter: HumanHero =
        com.example.typename_always_first.adapter.TestQuery_ResponseAdapter.Hero.HumanHero(responseAdapterCache)

    val DroidHeroAdapter: DroidHero =
        com.example.typename_always_first.adapter.TestQuery_ResponseAdapter.Hero.DroidHero(responseAdapterCache)

    val OtherHeroAdapter: OtherHero =
        com.example.typename_always_first.adapter.TestQuery_ResponseAdapter.Hero.OtherHero(responseAdapterCache)
