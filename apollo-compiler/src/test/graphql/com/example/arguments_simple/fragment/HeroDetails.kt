...
interface HeroDetails : GraphqlFragment {
  ...
  data class DefaultImpl(
    ...
    override fun marshaller(): ResponseFieldMarshaller {
      return ResponseFieldMarshaller.invoke { writer ->
        ...
        writer.writeObject(RESPONSE_FIELDS[1], this@DefaultImpl.friendsConnection.marshaller())
      }
    }
    ...
    companion object {
      ...
      operator fun invoke(reader: ResponseReader): DefaultImpl = reader.run {
        val __typename = readString(RESPONSE_FIELDS[0])!!
        val friendsConnection = readObject<FriendsConnection1>(RESPONSE_FIELDS[1]) { reader ->
  ...
  companion object {
    ...
    operator fun invoke(__typename: String, friendsConnection: FriendsConnection1): HeroDetails {
      return DefaultImpl(
        __typename = __typename,
        friendsConnection = friendsConnection
      )
