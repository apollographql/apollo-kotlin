            ...
            override fun fromResponse(reader: ResponseReader, __typename: String?):
              ...
              return reader.run {
                ...
                while(true) {
                  when (selectField(RESPONSE_FIELDS)) {
                    0 -> __typename = readString(RESPONSE_FIELDS[0])
                    1 -> node = readObject<TestQuery.Data.Hero.CharacterHero.FriendsConnection.Edge.Node>(RESPONSE_FIELDS[1]) { reader ->
          ...
          override fun fromResponse(reader: ResponseReader, __typename: String?):
            ...
            return reader.run {
              ...
              while(true) {
                when (selectField(RESPONSE_FIELDS)) {
                  0 -> __typename = readString(RESPONSE_FIELDS[0])
                  1 -> edges = readList<TestQuery.Data.Hero.OtherHero.FriendsConnection.Edge>(RESPONSE_FIELDS[1]) { reader ->
            ...
            override fun fromResponse(reader: ResponseReader, __typename: String?):
              ...
              return reader.run {
                ...
                while(true) {
                  when (selectField(RESPONSE_FIELDS)) {
                    0 -> __typename = readString(RESPONSE_FIELDS[0])
                    1 -> node = readObject<TestQuery.Data.Hero.OtherHero.FriendsConnection.Edge.Node>(RESPONSE_FIELDS[1]) { reader ->
                      Node.fromResponse(reader)
                    }
                    else -> break
                  }
