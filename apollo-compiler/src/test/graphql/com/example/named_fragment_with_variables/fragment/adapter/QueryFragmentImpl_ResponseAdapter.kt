...
object QueryFragmentImpl_ResponseAdapter : ResponseAdapter<QueryFragmentImpl> {
  ...
  override fun fromResponse(reader: ResponseReader, __typename: String?): QueryFragmentImpl {
    return reader.run {
      ...
      var organization: QueryFragmentImpl.Organization? = null
      while(true) {
        when (selectField(RESPONSE_FIELDS)) {
          0 -> __typename = readString(RESPONSE_FIELDS[0])
          1 -> organization = readObject<QueryFragmentImpl.Organization>(RESPONSE_FIELDS[1]) { reader ->
  ...
  object Organization : ResponseAdapter<QueryFragmentImpl.Organization> {
    private val RESPONSE_FIELDS: Array<ResponseField> = arrayOf(
    ...
    override fun fromResponse(reader: ResponseReader, __typename: String?):
        QueryFragmentImpl.Organization {
      return reader.run {
        var id: String? = null
        var user: List<QueryFragmentImpl.Organization.User>? = null
        while(true) {
          when (selectField(RESPONSE_FIELDS)) {
            0 -> id = readString(RESPONSE_FIELDS[0])
            1 -> user = readList<QueryFragmentImpl.Organization.User>(RESPONSE_FIELDS[1]) { reader ->
              reader.readObject<QueryFragmentImpl.Organization.User> { reader ->
    ...
    override fun toResponse(writer: ResponseWriter, value: QueryFragmentImpl.Organization) {
    ...
    object User : ResponseAdapter<QueryFragmentImpl.Organization.User> {
      private val RESPONSE_FIELDS: Array<ResponseField> = arrayOf(
        ResponseField.forString("__typename", "__typename", null, false, null)
      )

      override fun fromResponse(reader: ResponseReader, __typename: String?):
          QueryFragmentImpl.Organization.User {
      ...
      override fun toResponse(writer: ResponseWriter, value: QueryFragmentImpl.Organization.User) {
        when(value) {
          is QueryFragmentImpl.Organization.User.UserUser -> UserUser.toResponse(writer, value)
          is QueryFragmentImpl.Organization.User.OtherUser -> OtherUser.toResponse(writer, value)
        }
      }

      object UserUser : ResponseAdapter<QueryFragmentImpl.Organization.User.UserUser> {
        private val RESPONSE_FIELDS: Array<ResponseField> = arrayOf(
          ResponseField.forString("__typename", "__typename", null, false, null),
        ...
        override fun fromResponse(reader: ResponseReader, __typename: String?):
            QueryFragmentImpl.Organization.User.UserUser {
          return reader.run {
            var __typename: String? = __typename
        ...
        override fun toResponse(writer: ResponseWriter,
            value: QueryFragmentImpl.Organization.User.UserUser) {
          writer.writeString(RESPONSE_FIELDS[0], value.__typename)
      ...
      object OtherUser : ResponseAdapter<QueryFragmentImpl.Organization.User.OtherUser> {
        private val RESPONSE_FIELDS: Array<ResponseField> = arrayOf(
          ResponseField.forString("__typename", "__typename", null, false, null)
        )

        override fun fromResponse(reader: ResponseReader, __typename: String?):
            QueryFragmentImpl.Organization.User.OtherUser {
          return reader.run {
            var __typename: String? = __typename
            while(true) {
              when (selectField(RESPONSE_FIELDS)) {
        ...
        override fun toResponse(writer: ResponseWriter,
            value: QueryFragmentImpl.Organization.User.OtherUser) {
          writer.writeString(RESPONSE_FIELDS[0], value.__typename)
        }
      }
    }
