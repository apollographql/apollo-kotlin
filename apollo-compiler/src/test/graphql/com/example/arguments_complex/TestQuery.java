...
public final class TestQuery implements Query<TestQuery.Variables> {
  ...
  public static class Data implements Operation.Data {
    ...
    public static class HeroWithReview {
      ...
      public static final class Mapper implements ResponseFieldMapper<HeroWithReview> {
        final Field[] fields = {
          ...
          Field.forDouble("height", "height", Arrays.asList(new UnmodifiableMapBuilder<String, Object>(2)
            .put("name", "unit")
            .put("value", "FOOT")
          .build()), true)
        };
        ...
        public HeroWithReview map(ResponseReader reader) throws IOException {
          ...
          return new HeroWithReview(contentValues.name, contentValues.height);
        }
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      final Field[] fields = {
        Field.forObject("heroWithReview", "heroWithReview", Arrays.asList(new UnmodifiableMapBuilder<String, Object>(2)
          .put("name", "episode")
      ...
      public Data map(ResponseReader reader) throws IOException {
        ...
        reader.read(new ResponseReader.ValueHandler() {
          ...
          public void handle(final int fieldIndex, final Object value) throws IOException {
            switch (fieldIndex) {
              case 0: {
                contentValues.heroWithReview = (HeroWithReview) value;
                break;
              }
            }
          }
        }, fields);
        return new Data(contentValues.heroWithReview);
      }
