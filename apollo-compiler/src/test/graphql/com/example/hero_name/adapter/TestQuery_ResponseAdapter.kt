...
class TestQuery_ResponseAdapter(
  ...
  class Hero(
    ...
    val DroidHeroAdapter: DroidHero =
        com.example.hero_name.adapter.TestQuery_ResponseAdapter.Hero.DroidHero(responseAdapterCache)

    val OtherHeroAdapter: OtherHero =
        com.example.hero_name.adapter.TestQuery_ResponseAdapter.Hero.OtherHero(responseAdapterCache)
