...
import com.apollographql.compiler.ir.Field
import com.apollographql.compiler.ir.InlineFragment
...
class ResponseFieldMapperBuilder(
  ...
  private fun fieldArrayField() = FieldSpec
      .builder(Array<com.apollographql.api.graphql.Field>::class.java, "FIELDS", Modifier.PRIVATE, Modifier.FINAL)
  ...
  private fun responseFieldFactoryStatements(): CodeBlock {
    val typeNameFieldStatement = if (hasFragments) {
      CodeBlock.of("\$T.forString(\$S, \$S, null, false)", com.apollographql.api.graphql.Field::class.java,
          "__typename",
          "__typename")
    } else {
      CodeBlock.of("")
  ...
  companion object {
    ...
    private val API_RESPONSE_FIELD = ClassName.get(com.apollographql.api.graphql.Field::class.java)
    private val API_RESPONSE_FIELD_OBJECT_READER = ClassName.get(
        com.apollographql.api.graphql.Field.ObjectReader::class.java)
    private val API_RESPONSE_FIELD_LIST_READER = ClassName.get(
        com.apollographql.api.graphql.Field.ListReader::class.java)
    private val API_RESPONSE_FIELD_LIST_ITEM_READER = ClassName.get(
        com.apollographql.api.graphql.Field.ListItemReader::class.java)
