...
class ResponseFieldMapperBuilder(
  ...
  private fun fieldArrayField() = FieldSpec
      .builder(Array<com.apollographql.android.api.graphql.Field>::class.java, "FIELDS", Modifier.PRIVATE,
          Modifier.FINAL)
  ...
  private fun responseFieldFactoryStatements(): CodeBlock {
    val typeNameFieldStatement = if (hasFragments) {
      CodeBlock.of("\$T.forString(\$S, \$S, null, false)", com.apollographql.android.api.graphql.Field::class.java,
          "__typename",
          "__typename")
    } else {
      CodeBlock.of("")
  ...
  companion object {
    ...
    private val API_RESPONSE_FIELD = ClassName.get(com.apollographql.android.api.graphql.Field::class.java)
