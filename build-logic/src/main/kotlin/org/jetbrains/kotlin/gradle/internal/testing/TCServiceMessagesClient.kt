// Copied from https://github.com/JetBrains/kotlin/blob/v1.7.21/libraries/tools/kotlin-gradle-plugin/src/common/kotlin/org/jetbrains/kotlin/gradle/internal/testing/TCServiceMessagesClient.kt
// Modified to:
// - remove all kotlinDebug and LegacyTestDescriptorInternal references that are internal to the Kotlin Gradle Plugin
// - call failure() with a TestFailure instead of a Throwable
// https://youtrack.jetbrains.com/issue/KT-54634
/*
...
internal open class TCServiceMessagesClient(
  ...
  private fun TestNode.failure(
    ...
    results.failure(
        descriptor.id,
        TestFailure.fromTestAssertionFailure(KotlinTestFailure(
