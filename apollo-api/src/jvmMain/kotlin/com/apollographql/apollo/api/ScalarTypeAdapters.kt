...
actual class ScalarTypeAdapters actual constructor(customAdapters: Map<ScalarType, CustomTypeAdapter<*>>) {
  private val customAdapters = customAdapters.mapKeys { it.key.typeName() }

  @Suppress("UNCHECKED_CAST")
  actual fun <T : Any> adapterFor(scalarType: ScalarType): CustomTypeAdapter<T> {
  ...
  actual companion object {
    @JvmField
    actual val DEFAULT = ScalarTypeAdapters(emptyMap())
