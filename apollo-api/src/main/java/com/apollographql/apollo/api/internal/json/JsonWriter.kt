...
/**
 * Writes a JSON ([RFC 7159](http://www.ietf.org/rfc/rfc7159.txt))
...
abstract class JsonWriter : Closeable, Flushable {
   ...
   * only emits well-formed JSON as specified by [RFC 7159](http://www.ietf.org/rfc/rfc7159.txt). Setting the writer
